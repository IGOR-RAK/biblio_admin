      ...
      <Modal handleModal={handleModal}>
        <div className="item_creator">         
          ...
          <div className="form-floating mb-3">
            <input type="text" className="form-control" id="floatingInput" placeholder="...dyskryptor" value={items.newItem} onChange={handleInput}/>
            <label className="label" htmlFor="floatingInput">Nowy dyskryptor</label>
          </div>       
            
            <div style={{color:"red"}}>
            {items.newItemError&&<div className='mb-2' style={{color:"red"}}>{items.newItemError}</div>}
            </div>
            <button className='btn btn-primary' onClick={handleClick}>Create new Item</button>
