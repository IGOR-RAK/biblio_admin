...
function ImageLoader() {
    ...
    return (     
            <div className="img_loader">
                ...
                {
                        cards.isImageLoading ? <div className="spinner-border text-primary"></div>
                        :<div className="file_img mt-2">
                            <img className="img"  src={cards.initState.url ? cards.initState.url : no_image} alt="#"/> 
                            {cards.initState.url?<span className="cross" onClick={onDestroyClick}>&#10060;</span>:null}                          
                        </div>
                    }                
            </div>         
    )
